...
@Component({
  selector: 'app-numbersdirectoryshop',
  templateUrl: './numbersdirectoryshop.page.html',
  styleUrls: ['./numbersdirectoryshop.page.scss'],
})
export class NumbersdirectoryshopPage implements OnInit {
//post data
public app_label_185:any;
...
initialiseTranslation(){
  ...
  this.translate.get('app_label_185').subscribe((res: string) => {
    this.app_label_185 = res;
  });
